...
<template>
  <el-table v-loading="loading" border :data="props.data" empty-text="暂时没有数据哟🌻" highlight-current-row
    @current-change="handleCurrentChange">
    <el-table-column label="序号" prop="imageId" width="60px" align="center" type="index"></el-table-column>
    <el-table-column label="图片" prop="path" width="65px" align="center">
      <template #default="{ row }">
        <img v-lazy="getMediaUrl(row.url)" style="height: 40px; width: 40px; object-fit: cover" />
      </template>
    </el-table-column>
    <el-table-column label="图片名称" prop="name" width="160px" align="center"
      :show-overflow-tooltip="true"></el-table-column>
    <el-table-column label="标签" prop="tags" width="180px" align="center" :show-overflow-tooltip="true">
      <template #default="{ row }">
    ...
    <el-table-column label="大小" prop="size" width="120px" align="center" :show-overflow-tooltip="true">
      <template #default="{ row }">
        {{ formatFileSize(row.size) }}
      </template>
    </el-table-column>
    <el-table-column label="类型" prop="type" width="60px" align="center" :show-overflow-tooltip="true"></el-table-column>
    <el-table-column label="拍照时间" prop="createTime" width="180px" align="center"
      :show-overflow-tooltip="true"></el-table-column>

    <el-table-column label="拍照地点" prop="createAddress" width="180px" align="center" :show-overflow-tooltip="true">
      <template #default="{ row }">
        {{ row.createAddress.address }}
      </template>
    </el-table-column>
    <el-table-column label="设备名称" prop="deviceName" width="150px" align="center"
      :show-overflow-tooltip="true"></el-table-column>
    <el-table-column label="上传时间" prop="uploadTime" width="180px" align="center"
      :show-overflow-tooltip="true"></el-table-column>
