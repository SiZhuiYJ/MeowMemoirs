<template>
  <!-- 主题配置 -->
  <KoiDrawer ref="koiDrawerRef" title="主题配置" :footerHidden="true">
    <template #content>
      <el-row>
      ...
      <div class="w-full flex flex-wrap flex-justify-between">
        <div class="flex flex-col">
          <div
            class="rounded-md border-1px border-dashed border-[--el-border-color-darker] shadow-[--el-box-shadow-lighter]"
      ...
      <div class="layout-box">
        ...
        <el-tooltip content="混合" placement="top" :show-after="200">
          <div :class="['layout-item layout-optimum', { 'is-active': layout == 'optimum' }]"
        ...
        <el-tooltip content="横向" placement="top" :show-after="200">
          <div :class="['layout-item layout-horizontal', { 'is-active': layout == 'horizontal' }]"
        ...
        <el-row>
          ...
          <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
            <el-form-item>
              ...
              <el-switch active-text="启用" inactive-text="停用" :active-value="true" :inactive-value="false"
                :inline-prompt="true" v-model="uniqueOpened">
              </el-switch>
            </el-form-item>
          </el-col>
          <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
            <el-form-item label="侧边栏反转色">
              <el-switch active-text="启用" inactive-text="停用" :active-value="true" :inactive-value="false"
                :inline-prompt="true" v-model="asideInverted" @change="setAsideTheme">
              </el-switch>
            </el-form-item>
          </el-col>
          <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
            <el-form-item label="头部反转色">
              <el-switch active-text="启用" inactive-text="停用" :active-value="true" :inactive-value="false"
                :inline-prompt="true" v-model="headerInverted" @change="setHeaderTheme">
              </el-switch>
            </el-form-item>
          </el-col>
          <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
            <el-form-item label="灰色模式">
              <el-switch active-text="启用" inactive-text="停用" :active-value="true" :inactive-value="false"
                :inline-prompt="true" v-model="isGrey" @change="changeGreyOrWeak('grey', !!$event)">
              </el-switch>
            </el-form-item>
          </el-col>
          <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
            <el-form-item label="色弱模式">
              <el-switch active-text="启用" inactive-text="停用" :active-value="true" :inactive-value="false"
                :inline-prompt="true" v-model="isWeak" @change="changeGreyOrWeak('weak', !!$event)">
              </el-switch>
            </el-form-item>
          </el-col>
          <el-col :sm="{ span: 24 }" :xs="{ span: 24 }">
            <el-form-item label="折叠菜单">
              <el-form-item>
                <el-switch v-model="isCollapse" active-text="展开" inactive-text="折叠" :active-value="true"
                  :inactive-value="false" :inline-prompt="true">
                </el-switch>
              </el-form-item>
            </el-form-item>
          </el-col>
