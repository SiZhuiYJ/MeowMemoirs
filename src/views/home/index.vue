      ...
      <div class="flex flex-items-center" v-waterMarker="{ text: 'KOI-ADMIN', textColor: '#D9D9D9' }">
        ...
        <div class="p-l-20px">
          <div class="font-bold p-b-8px whitespace-nowrap">
            <span>KOI-ADMIN🌻</span><span class="c-#6169FF"
              @click="handleKoiAdminGitee">前后端版本[129块]</span><span>/</span><span class="c-#409EFF"
              @click="handleKoiUIGitee">纯前端[Gitee]</span><span>/</span><span class="c-orange"
              @click="handleKoiUIGitHub">纯前端[GitHub]</span>
          </div>
