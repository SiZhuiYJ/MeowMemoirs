    ...
    <div class="progressive-container">
        ...
        <div class="cover">
            <ProgressiveImage
                ...
                :placeholder="
                    getStaticFileUrl(
                        `img/home/_${isMobile ? '9' : '1'}-720p.webp`
                    )
                "
                :origin="
                    getStaticFileUrl(`img/home/_${isMobile ? '9' : '1'}.webp`)
                "
            />
            ...
            >
                <div class="typing-title">
                    欢迎来到<span style="font-size: 30px; color: #e3c0df"
                        >喵咪记事簿</span
                    >
                </div>
        ...
        <div class="page-break">
            <ProgressiveImage
                ...
                :placeholder="
                    getStaticFileUrl(
                        `img/home/_${isMobile ? '1' : '9'}-720p.webp`
                    )
                "
                :origin="
                    getStaticFileUrl(`img/home/_${isMobile ? '1' : '9'}.webp`)
                "
            />
        </div>
        <div class="page-break">
