...
const openWebsite = () => {
  // 新窗口打开网站
  window.open("https://github.com/SiZhuiYJ");
};
// 打开邮件方法
const openEmail = () => {
  // 邮箱
  window.open("mailto:tslj7454612@gmail.com");
};
</script>
<template>
  <div class="card">
    <button class="mail" @click="openEmail">
      <svg
    ...
    <div class="bottom">
      <div class="content">
        ...
        <span class="about-me">业余爱好者 </span>
      </div>
      <div class="bottom-bottom">
        ...
        <button class="button">私信我</button>
      </div>
    </div>
  </div>
</template>
