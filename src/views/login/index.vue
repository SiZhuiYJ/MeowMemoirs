...
const background = computed(() => {
    return isMobile.value ? getLocalImgUrl('_9.webp') : isPad.value ? getLocalImgUrl('_4.webp') : isScreen.value ? getLocalImgUrl('_3.webp') : isDesktop.value ? getLocalImgUrl('_1.webp') : getLocalImgUrl('_8.webp')
})
